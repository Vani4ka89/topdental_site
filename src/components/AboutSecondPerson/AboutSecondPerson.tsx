...
const AboutSecondPerson: FC = () => {
    ...
    const doctor = content.doctors.items[1];
    ...
    return (
        <section className="doctor-section doctor-section--secondary td-section">
            <Container className="doctor-section__container">
                <Reveal className="doctor-section__image" delay={100}>
                    <img src={doctor.image.src} alt={doctor.image.alt} loading="lazy"/>
                </Reveal>
                <Reveal className="doctor-section__content">
