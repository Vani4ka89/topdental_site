    ...
    return (
        <section style={{width: '100%'}}>
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        Найкращий варіант замінити відсутній зуб - це імплантація. Імплант буде на місці кореня зуба і
                        стане надійною точкою опори для подальшого протезування. Завдяки цьому варіанту ви отримаєте
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        У середньому загоєння триває 14-20 днів, але все залежить від індивідуальних особливостей
                        пацієнта, його загального стану здоровʼя. Важливо правильно доглядати за ротовою порожниною та
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                >
                    <Typography sx={{width: '100%', flexShrink: 0}}>
                        Скільки часу триває процедура гігієни порожнини рота? І як часто потрібно робити дану процедуру?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        Професійну гігієну порожнини рота рекомендовано проводити 2-3 рази на рік. Тривалість процедури
                        визначається індивідуально, залежно від стану ротової порожнини. В середньому — 40 хвилин.
                    </Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                ...
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        ...
                        <br/>
                        ● в більшості випадків вони займають неправильне положення - ростуть в бік щоки або нахиляються
            ...
            <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                ...
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        Так, сучасні методи лікування надають змогу починати ортодонтичне лікування і в 15, і в 30, і в
                        60 років.
                        Можливо, в більш зрілих пацієнтів це буде довший процес, але в цілому сучасні брекет-системи
            ...
            <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
                ...
                <AccordionDetails>
                    <Typography sx={{fontStyle: 'italic'}}>
                        ...
                        <br/>
                        <br/>
                        Який метод лікування буде ефективнішим саме для вашого випадку може визначити лише ортодонт
